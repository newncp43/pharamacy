...
<html lang="en">
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                <form  name="addproduct" action="add_track_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal"><br>
         <div class="u-form-group">
             <p>Add track number</p>
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
                    <input type="tracknumber" name="tracknumber" placeholder="tracknumber" class="form-control" style="width: 300px;"/>
                </div>
