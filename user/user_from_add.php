...
<div class="container">
  <div class="row">
      <form  name="addproduct" action="user_from_add_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
         <div class="u-form-group">
          ...
          <div class="form-group"><br>
            <button type="submit" class="btn btn-success" name="saveuser"> บันทึก </button>
          <div class="col-sm-12">
